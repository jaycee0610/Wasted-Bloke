...
<body>
    ...
    <div class="container animate__animated animate__fadeIn shadow-lg mt-2 p-3 mb-5 mt-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 border-start border-dark pt-3">
                <i class="fw-bold p-2 ">ABOUT WASTED BLOKE</i>
                <img class="img-fluid d-none d-md-block" src="assets/images/2.jpg" alt="">
                <h3 class="headline2 mt-3">IT’S A SOCIAL PROBLEM</h3>
                <div class="text-center mb-3 mt-3">
                    <p class="border-top pt-2 mb-3 border-dark border-bottom pb-2 w-50 d-inline">NOT JUST A MEME</p>
                </div>
            ...
            <div class="col-sm-3  border-bottom border-dark pt-3">
        ...
        <div class="row mb-3 ">
            ...
            <div class="col-sm-7 ">
                ...
                <div class="container">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-3 d-flex justify-content-center align-items-center mb-0">
                ...
                <div class="border border-dark p-2 mt-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="assets/images/book.jpg" alt="" class="img-fluid mb-3">
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="row mb-3 mt-5">
            <div class="col-12">
                <div class="text-center">
                    <h3 class="h13 d-block" style="font-size:50px;margin:0;padding:0;">JOIN OUR PRESALE
                    </h3>
                    <a class="btn btn-dark  ">Join Now</a>
                    <p class="mt-3">Copyright 2024 WastedBloke
        ...
        <div class="row border-top border-dark mt-5" style="">
            <div class="col-8  p-2">
                <p class="headline2 float-start">THE NEGLECTED NEWS EDITION 2024</p>
            </div>
            <div class="col-4 ">
    ...
    <div class="modal fade" id="onload" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content modal-default">
                ...
                This pop-up warning is for informational purposes only and does not constitute financial advice. Always conduct your own research and consult with a qualified financial advisor before making investment decisions.Before you dive in, consider its impact on societal challenges like poverty, homelessness, and alcoholism. While it offers opportunities, it also poses risks, especially for vulnerable communities. Prioritize understanding the market, protect against scams, and never invest more than you can afford to lose. Stay informed, cautious, and seek advice to invest responsibly.
